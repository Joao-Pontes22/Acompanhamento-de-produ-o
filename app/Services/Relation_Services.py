...
from app.Schemes.Relation_Schemes import RelationScheme
...
class RelationPartsxComponents_Services:
    ...
    def service_create_relation(self, scheme:RelationScheme):
    ...
    def service_get_relations_filtred(self, id:int = None, 
